...
//ls -ls (ls lists the files in the current directory, -l shows the list in long format (permissions, size, owner, time..),-s adds the size (in disk blocks) to each line):  lists all files, with full details and shows size.
